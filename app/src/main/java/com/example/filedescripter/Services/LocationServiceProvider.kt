...
object LocationServiceProvider {
    ...
    fun getLastLocation(recursiveFileObserver: RecursiveFileObserver, fileId: String, locationServices: FusedLocationProviderClient): String? {
    ...
    fun isLocationEnabled(): Boolean {
        val locationManager: LocationManager =
            Instance.applicationContext.getSystemService(Context.LOCATION_SERVICE) as LocationManager
